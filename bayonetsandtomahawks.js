...
var winterQuartersProcedureConfig = function (game) { return [
...
var returnToColoniesProcedureConfig = function (game) { return [
...
var spacesInfoConfig = function (game) { return [
    {
...
var tplGameMapInfo = function (game) { return "\n  ".concat(spacesInfoConfig(game).map(function (_a) {
    var images = _a.images, text = _a.text, title = _a.title;
    return "\n    <div class=\"bt_space_info_row\">\n      <div class=\"bt_space_info_images\">\n        ".concat(images.map(function (_a) {
        var width = _a.width, height = _a.height, top = _a.top, left = _a.left;
        return "<div class=\"bt_space_image\" style=\"width: ".concat(width, "px; height: ").concat(height, "px; background-position: ").concat(left, "px ").concat(top, "px;\"></div>");
    }).join(''), "\n      </div>\n      <div class=\"bt_space_text\">\n        <span class=\"title\">").concat(title, "</span>\n        <span class=\"text\">").concat(text, "</span>\n      </div>\n    </div>\n    ");
}).join(''), "\n  "); };
var tplWinterQuartersRow = function (text, index) { return "\n<tr>\n  <td class=\"bt_winterQuarters_details\">\n    <span class=\"bt_procedure_number\">".concat(index + 1, ".</span><span>").concat(text, "</span>\n  </td>\n</tr>\n"); };
var tplWinterQuartersInfo = function (game) { return "\n  <table id=\"bt_winter_quarters_procedure_info\">\n    <tr>\n      <th><h3 class=\"section_title\">".concat(_('Winter Quarters Procedure'), "</h3></th>\n    </tr>\n    ").concat(winterQuartersProcedureConfig(game).map(function (text, index) { return tplWinterQuartersRow(text, index); }).join(''), "\n  </table>\n\n  <table id=\"bt_return_to_colonies_procedure_info\">\n    <tr>\n      <th><h3 class=\"section_title\">").concat(_('Return to Colonies'), "</h3>\n    <span>").concat(_('No AP required. Ignore enemy units / enemy-controlled spaces / Connection Limits / Fleet transport capacity / MP Limits'), "</span>\n    </th>\n    </tr>\n    ").concat(returnToColoniesProcedureConfig(game).map(function (text, index) { return tplWinterQuartersRow(text, index); }).join(''), "\n  </table>\n  "); };
