...
class SailMovementDestination extends \BayonetsAndTomahawks\Actions\UnitMovement
{
  ...
  public function stSailMovementDestination()
  {
  }
  ...
  public function stPreSailMovementDestination()
  {
  }
  ...
  public function argsSailMovementDestination()
  {
  ...
  public function actPassSailMovementDestination()
  {
    $player = self::getPlayer();
  ...
  public function actSailMovementDestination($args)
  {
    self::checkAction('actSailMovementDestination');
    ...
    // $stateArgs = $this->argsSailMovementDestination();
