...
const ST_DRAW_RESERVE_CARDS = 49;
...
const ST_MOVEMENT_LONE_COMMANDER = 128;
...
const ST_BATTLE_MOVE_FLEET = 157;
const ST_BATTLE_SELECT_SPACE = 158;
const ST_BATTLE_OVERWHELM_DURING_RETREAT = 159;
...
const ST_EVENT_PLACE_INDIAN_NATION_UNITS = 185;
...
const ST_WINTER_QUARTERS_PLACE_UNITS_FROM_LOSSES_BOX = 204;
...
const FrenchIndianWarFullCampaign1755_1759 = 'FrenchIndianWarFullCampaign1755_1759';
...
const ACTION_ROUND_DRAW_CARDS = 'ACTION_ROUND_DRAW_CARDS';
...
const BATTLE_MOVE_FLEET = 'BATTLE_MOVE_FLEET';
const BATTLE_OVERWHELM_DURING_RETREAT = 'BATTLE_OVERWHELM_DURING_RETREAT';
...
const EVENT_PLACE_INDIAN_NATION_UNITS = 'EVENT_PLACE_INDIAN_NATION_UNITS';
...
const MOVEMENT_LONE_COMMANDER = "MOVEMENT_LONE_COMMANDER";
...
const WINTER_QUARTERS_PLACE_UNITS_FROM_LOSSES_BOX = 'WINTER_QUARTERS_PLACE_UNITS_FROM_LOSSES_BOX';
 ...
 */
 ...
 const STAT_WINNER = 10;
 const STAT_WINNER_BRITISH = 0;
 const STAT_WINNER_FRENCH = 1;

 const STAT_PLAYER_WIN_PERCENTAGE_AS_BRITISH = 30;
 const STAT_PLAYER_WIN_PERCENTAGE_AS_FRENCH = 31;
 const STAT_PLAYER_RAID = 32;
 const STAT_PLAYER_MOVEMENT = 33;
 const STAT_PLAYER_MARSHAL_TROOPS = 34;
 const STAT_PLAYER_CONSTRUCTION = 35;
 const STAT_PLAYER_REACTION = 36;

 const STATS_SIDE_SPECIFIC = [
  BRITISH => [
    STAT_PLAYER_WIN_PERCENTAGE_AS_BRITISH
  ],
  FRENCH => [
    STAT_PLAYER_WIN_PERCENTAGE_AS_FRENCH
  ]
];