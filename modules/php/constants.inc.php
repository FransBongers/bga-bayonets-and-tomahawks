...
const ST_DRAW_REINFORCEMENTS = 30;
const ST_VAGARIES_OF_WAR_PICK_UNITS = 31;
const ST_VAGARIES_OF_WAR_PUT_BACK_IN_POOL = 35;
const ST_FLEETS_ARRIVE_COMMANDER_DRAW = 32;
const ST_FLEETS_ARRIVE_UNIT_PLACEMENT = 33;
const ST_LOGISTICS_ROUND_END = 34;
const ST_COLONIALS_ENLIST_UNIT_PLACEMENT = 41;
const ST_WINTER_QUARTERS_GAME_END_CHECK = 50;
const ST_WINTER_QUARTERS_ROUND_END = 55;
const ST_ACTION_ACTIVATE_STACK = 60;
const ST_RAID_SELECT_TARGET = 61;
const ST_RAID_MOVE = 62;
const ST_RAID_RESOLUTION = 63;
const ST_RAID_INTERCEPTION = 64;
const ST_RAID_REROLL = 65;
const ST_MOVEMENT = 66;
const ST_MARSHAL_TROOPS = 68;
const ST_CONSTRUCTION = 69;

const ST_ACTION_ROUND_RESOLVE_AR_START_EVENT = 70;

const ST_MOVEMENT_LOSE_CONTROL_CHECK = 71;
const ST_MOVEMENT_BATTLE_AND_TAKE_CONTROL_CHECK = 72;
const ST_MOVEMENT_OVERWHELM_CHECK = 73;
const ST_MOVEMENT_PLACE_SPENT_MARKERS = 74;
const ST_MOVE_STACK = 75;
const ST_PLACE_MARKER_ON_STACK = 76;
const ST_SAIL_MOVEMENT = 77;

const ST_BATTLE_PREPARATION = 80;
const ST_BATTLE_SELECT_COMMANDER = 81;
const ST_BATTLE_ROLLS = 82;
const ST_BATTLE_ROLLS_REROLLS = 110;
const ST_BATTLE_ROLLS_ROLL_DICE = 83;
const ST_BATTLE_ROLLS_EFFECTS = 84;
const ST_BATTLE_APPLY_HITS = 85;
const ST_BATTLE_OUTCOME = 86;
const ST_BATTLE_ROUT = 87;
const ST_BATTLE_RETREAT = 88;
const ST_BATTLE_CLEANUP = 89;
const ST_BATTLE_RETREAT_CHECK_OPTIONS = 79;
const ST_BATTLE_MILITIA_ROLLS = 140;
const ST_BATTLE_COMBINE_REDUCED_UNITS = 141;
const ST_BATTLE_PENALTIES = 142;
const ST_BATTLE_PRE_SELECT_COMMANDER = 143;
const ST_BATTLE_FORT_ELIMINATION = 144;

const ST_EVENT_BRITISH_ENCROACHMENT = 120;
const ST_EVENT_DISEASE_IN_FRENCH_CAMP = 121;
const ST_EVENT_ROUND_UP_MEN_AND_EQUIPMENT = 122;
const ST_EVENT_PENNSYLVANIAS_PEACE_PROMISES = 123;
const ST_EVENT_DELAYED_SUPPLIES_FROM_FRANCE = 124;
const ST_EVENT_SMALLPOX_INFECTED_BLANKETS = 125;
const ST_EVENT_DISEASE_IN_BRITISH_CAMP = 126;
const ST_EVENT_ARMED_BATTOEMEN = 127;
const ST_EVENT_SMALLPOX_EPIDEMIC = 128;
const ST_EVENT_HESITANT_BRITISH_GENERAL = 129;
const ST_EVENT_STAGED_LACROSSE_GAME = 130;
const ST_EVENT_WILDERNESS_AMBUSH = 131;
const ST_USE_EVENT = 132;
